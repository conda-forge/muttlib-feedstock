...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/muttlib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14216&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/muttlib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `muttlib` can be installed with:

```
conda install muttlib
```

It is possible to list all of the versions of `muttlib` available on your platform with:
